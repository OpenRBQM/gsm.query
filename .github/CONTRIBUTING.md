# Contributing to gsm.query

This outlines how to propose a change to gsm.query.
...
*   Fork the package and clone onto your computer. If you haven't done this before, we recommend using `usethis::create_from_github("OpenRBQM/gsm.query")`.
...
Please note that the gsm.query project is released with a
